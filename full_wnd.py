...
def train_and_evaluate(input_dim, hidden_dims, dropout, learning_rate, batch_size):
    model = WideDeepNN(input_dim, hidden_dims, dropout).to(device)
...
model = WideDeepNN(input_dim, best_hidden_dims, best_dropout).to(device)
